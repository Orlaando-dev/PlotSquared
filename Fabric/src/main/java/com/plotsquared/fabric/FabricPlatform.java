...
public final class BukkitPlatform extends JavaPlugin implements Listener, PlotPlatform<Player> {
    ...
    public void startMetrics() {
        //B-stats doesn't support fabric
        return;
    }
    ...
    public void onEnable() {
        ...
        if (
            Settings.UUID.LEGACY_DATABASE_SUPPORT &&
    ...
    private void unload() {
        if (!this.methodUnloadSetup) {
            ...
            try {
                ...
                this.methodUnloadChunk0 =
                    classCraftWorld.getRealClass().getDeclaredMethod("unloadChunk0", int.class, int.class, boolean.class);
        ...
        if (this.plotAreaManager instanceof SinglePlotAreaManager) {
            ...
            outer:for (final World world : Bukkit.getWorlds()) {
                ...
                if (plot != null) {
                    if (
                        !plot.getFlag(ServerPlotFlag.class) ||
                        PlotSquared.platform().playerManager().getPlayerIfExists(plot.getOwner()) == null
                    ) {
                                ...
                                switch (entity.getType().toString()) {
                                    ...
                                    case "BOAT":
                                        if (Settings.Enabled_Components.KILL_ROAD_VEHICLES) {
                                            com.plotsquared.core.location.Location location = BukkitUtil.adapt(
                                                entity.getLocation()
                                            );
                                    ...
                                    case "DROPPED_ITEM":
                                        if (
                                            Settings.Enabled_Components.KILL_ROAD_ITEMS &&
                                    ...
                                    case "SHULKER":
                                        if (
                                            Settings.Enabled_Components.KILL_ROAD_MOBS &&
                                            ...
                                            if (!meta.isEmpty()) {
                                                if (
                                                    livingEntity.isLeashed() && !Settings.Enabled_Components.KILL_OWNED_ROAD_MOBS
                                                ) {
                                                    continue;
                                                }
                                                ...
                                                if (originalPlotId != null) {
                                                    com.plotsquared.core.location.Location pLoc = BukkitUtil.adapt(
                                                        entity.getLocation()
                                                    );
                                            ...
                                            if (Settings.Enabled_Components.KILL_ROAD_MOBS) {
                                                ...
                                                if (BukkitUtil.adapt(location).isPlotRoad()) {
                                                    if (entity instanceof LivingEntity livingEntity) {
                                                        if (
                                                            (
                                                                Settings.Enabled_Components.KILL_OWNED_ROAD_MOBS ||
                                                            ...
                                                            if (
                                                                ...
                                                                (
                                                                    Settings.Enabled_Components.KILL_NAMED_ROAD_MOBS ||
    ...
    @Override
    @Nullable
    public final ChunkGenerator getDefaultWorldGenerator(final @NonNull String worldName, final @Nullable String id) {
    ...
    public void setGenerator(final @NonNull String worldName) {
        ...
        if (world == null) {
            ...
            PlotAreaBuilder builder = PlotAreaBuilder
                .newBuilder()
                .plotManager(manager)
    ...
    public @NonNull String pluginsFormatted() {
        ...
        for (Plugin p : plugins) {
            msg
                ...
                .append("\n")
                .append("  • Main: ")
                .append(p.getDescription().getMain())
                .append("\n")
                .append("  • Authors: ")
                .append(p.getDescription().getAuthors())
                .append("\n")
                .append("  • Load Before: ")
                .append(p.getDescription().getLoadBefore())
                .append("\n")
                .append("  • Dependencies: ")
                .append(p.getDescription().getDepend())
                .append("\n")
                .append("  • Soft Dependencies: ")
                .append(p.getDescription().getSoftDepend())
                .append("\n");
        }
        return msg.toString();
    }
    ...
    public @NonNull String worldEditImplementations() {
        ...
        if (Bukkit.getPluginManager().getPlugin("FastAsyncWorldEdit") != null) {
            msg
                .append("FastAsyncWorldEdit: ")
                .append(Bukkit.getPluginManager().getPlugin("FastAsyncWorldEdit").getDescription().getVersion());
        } else if (Bukkit.getPluginManager().getPlugin("AsyncWorldEdit") != null) {
            msg
                .append("AsyncWorldEdit: ")
                .append(Bukkit.getPluginManager().getPlugin("AsyncWorldEdit").getDescription().getVersion())
                .append("\n");
